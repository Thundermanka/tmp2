...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(823, 25);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Дан двумерный массив NxM. Найти количество строк упорядоченных по возрастанию\r\n";
			// 
			// label2
			// 
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		textBox3->Text = Convert::ToString(reshenie(n, m, a));
		   ...
		   int  reshenie(int n, int m, int a[10][10]) {
			   int counter = 0;
			   for (int i = 0; i < n; i++) {
				   int tmp = 0;
				   for (int j = 0; j < m-1; j++) {
